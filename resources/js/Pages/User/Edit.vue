...
const submit = () => {
  router.put(`/users/${user.value.id}`, user.value);
};
...
<template>
  ...
  <AuthenticatedLayout>
    <div class="p-4 mx-auto max-w-xl md:p-6">
      <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-white mb-6">Edit Pengguna</h2>
