...
const users = ref([
  {
    name: 'Lindsey Curtis',
    role: 'Web Designer',
    avatar: 'storage/images/user/user-17.jpg',
    project: 'Agency Website',
    team: ['storage/images/user/user-22.jpg', 'storage/images/user/user-23.jpg', 'storage/images/user/user-24.jpg'],
    status: 'Active',
    budget: '3.9K',
  },
  {
    ...
    avatar: 'storage/images/user/user-18.jpg',
    project: 'Technology',
    team: ['storage/images/user/user-25.jpg', 'storage/images/user/user-26.jpg'],
    status: 'Pending',
    budget: '24.9K',
  },
  {
    name: 'Zain Geidt',
    role: 'Content Writer',
    avatar: 'storage/images/user/user-19.jpg',
    project: 'Blog Writing',
    team: ['storage/images/user/user-27.jpg'],
    status: 'Active',
    budget: '12.7K',
  },
  {
    ...
    avatar: 'storage/images/user/user-20.jpg',
    project: 'Social Media',
    team: ['storage/images/user/user-28.jpg', 'storage/images/user/user-29.jpg', 'storage/images/user/user-30.jpg'],
    status: 'Cancel',
    budget: '2.8K',
  },
  {
    ...
    avatar: 'storage/images/user/user-21.jpg',
    project: 'Website',
    team: ['storage/images/user/user-31.jpg', 'storage/images/user/user-32.jpg', 'storage/images/user/user-33.jpg'],
    status: 'Active',
    budget: '4.5K',
  },
])
