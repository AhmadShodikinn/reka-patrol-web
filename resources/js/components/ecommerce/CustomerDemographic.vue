  ...
  >
    ...
    <div class="space-y-5">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="items-center w-full rounded-full max-w-8">
            <img src="/public/storage/images/country/country-01.svg" alt="usa" />
          </div>
          <div>
        ...
        <div class="flex w-full max-w-[140px] items-center gap-3">
          <div class="relative block h-2 w-full max-w-[100px] rounded-xs bg-gray-200 dark:bg-gray-800">
            <div
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="items-center w-full rounded-full max-w-8">
            <img src="/public/storage/images/country/country-02.svg" alt="france" />
          </div>
          <div>
