...
<body>
    <div id="wm"></div>
    <div class="cover">
        <h2>LAPORAN SEMENTARA INSPEKSI 5R</h2>
    ...
    <div class="content">
        <table id="details">
            <tbody>
                ...
                <tr>
                    <td>Pelaksanaan Inspeksi 5R</td>
                    <td>:</td>
                    <td>{{$inspectionRecap->from_date}} - {{$inspectionRecap->to_date}}</td>
                </tr>
        ...
        <table style="margin-top: 20px">
            <thead>
                <tr>
                    <th width="7%">No</th>
                    <th width="20%">Kriteria Temuan</th>
                    <th width="19%">Deskripsi Temuan</th>
                    <th width="14%">Validasi Temuan</th>
